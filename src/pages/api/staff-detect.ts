...
async function getEmployeeImages(token:string) //: Promise<Array<{ cid: number, ctaikhoan: string, choten: string, cimg: string, cngaytao: string }>> 
{
...
const luuanhnguoidung = async (pUser: string, pOpt: string, cid: number, ctaikhoan: string, choten: string, cimg: string,token: string) => {
  try {
