    ...
    >
      ...
      {currentStep === "form" && (
        <Card sx={{ width: "100%" }}>
          ...
          <Card elevation={3} >
          <CardContent sx={{textAlign:"center"}}>
            <Typography component="span" fontStyle="italic" color="red" textAlign="center" fontSize="1.5rem"> * Quét mã QR trên CCCD hoặc BHYT để tự động lấy thông tin.</Typography>
